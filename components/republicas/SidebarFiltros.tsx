...
// Nota: SidebarFiltros não acessa o banco diretamente.
// Ele apenas gerencia query params na URL — os nomes dos params
// (preco_max, genero, pets, etc.) não mudam, só o lib/republicas.ts
// que os mapeia para as colunas corretas. Nenhuma alteração necessária.
//
// O filtro "tipo de quarto" foi mantido na UI mas ainda não existe
// como coluna no banco. Adicione quando implementar essa feature.
...
export default function SidebarFiltros() {
  ...
  const labelClass =
    "text-[10px] font-medium uppercase tracking-widest text-zinc-400 mb-2 block";
